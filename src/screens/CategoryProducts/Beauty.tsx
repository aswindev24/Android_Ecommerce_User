...
type BeautyScreenNavigationProp = NativeStackNavigationProp<HomeStackParamList, 'Beauty'>;

interface Props {
    navigation: BeautyScreenNavigationProp;
}

const Beauty: React.FC<Props> = ({ navigation }) => {
    const { addToCart } = useCart();
    const [products, setProducts] = useState<Product[]>([]);
    const [searchQuery, setSearchQuery] = useState('');
    const insets = useSafeAreaInsets();
    const CATEGORY_NAME = 'Beauty';
