...
type HomeAppliancesScreenNavigationProp = NativeStackNavigationProp<HomeStackParamList, 'HomeAppliances'>;

interface Props {
    navigation: HomeAppliancesScreenNavigationProp;
}

const HomeAppliances: React.FC<Props> = ({ navigation }) => {
            ...
            <View style={[styles.header, { paddingTop: insets.top + SPACING.xs }]}>
                ...
                <View style={styles.searchBar}>
                    ...
                    <TextInput
                        ...
                        placeholder="Search in Home & Living..."
