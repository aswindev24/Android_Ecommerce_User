...
type FashionScreenNavigationProp = NativeStackNavigationProp<HomeStackParamList, 'Fashion'>;

interface Props {
    navigation: FashionScreenNavigationProp;
}

const Fashion: React.FC<Props> = ({ navigation }) => {
